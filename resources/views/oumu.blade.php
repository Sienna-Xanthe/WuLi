...
<body>
    <div>
        ...
        <h3>二、实验仪器与设备</h3>
        <div style="text-indent: 2rem;">① 500µA微安表一个</div>
        <div style="text-indent: 2rem;">② 六档位多档开关一组</div>
        <div style="text-indent: 2rem;">③ 9999.9型电阻箱三个</div>
        <div style="text-indent: 2rem;">④ 红黑表笔一副</div>
        <div style="text-indent: 2rem;">⑤ 1.5V电池一节</div>
        <div style="text-indent: 2rem;">⑥ 单刀开关一个</div>
        <div style="text-indent: 2rem;">⑦ 待测信号箱</div>
        <h3>三、实验原理</h3>
        ...
        <!-- <div style="text-indent: 2rem;">3）由于Ix与RΩ+Rx是非线性关系。当Rx≪RΩ时，有Ix≈E/RΩ =Ig，此时偏转接近满刻度，随Rx的变化不明显，因而测量误差大；当Rx≫RΩ时，Ix≈0，因而测量误差也大。所以在实际测量时，只在1/5RΩ<Rx<5RΩ的范围，测量才比较准确。</div> -->
                ...
                <tr>
                    ...
                    <td rowspan="4" valign="top">表头测量数据截图 （<span style="color: skyblue;">10分</span>）
                        <div style="width: 190px; height: 157px;">
                            <img src="{{$p1}}"
                                style="height: 99%;width: 99%;" class="jietu">
                        </div>
                    </td>
            ...
            <tr>
                <td valign="top">实验电路设计截图（<span style="color: skyblue;">15分</span>）
                    <div style="width: 590px; height: 350px;">
                        <img src="{{$p2}}"
                            style="height: 99%;width: 99%;" class="jietu"></div>
                </td>
            </tr>
        </table>
        <p>判断题</p>
