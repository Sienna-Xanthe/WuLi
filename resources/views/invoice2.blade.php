...
<body>
    <div style="margin: 0 auto; width: 655px;">
        ...
        <div style="text-indent: 2em; ">它表示电桥平衡后，RX的相对该变量ΔRX / RX 所引起的检流计偏转的格数Δn，具体测量时用ΔR0/R0 代替ΔRX/RX 。</div>
        <h3>四、 实验内容与步骤</h3>
        ...
        <table cellspacing="0" style="width: 655px; border-bottom: none; ">
            ...
            <tr style="height: 50px; text-align: center; ">
                ...
                <td>0.1</td>
                <td>0.1</td>
                <th rowspan="3 " style="width: 64px; ">RX=</th>
                <th rowspan="3 " style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</th>
                <th rowspan="3 " style="width: 64px;border-right: none; ">Ω</th>
            </tr>
            <tr style="height: 50px; text-align: center; ">
                <td>电阻臂R0(Ω)</td>
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
            </tr>
            <tr style="height: 50px; text-align: center; ">
        ...
        <table cellspacing="0" style="width: 655px; border-top: none;border-bottom: none; ">
            ...
            <tr style="height: 50px; text-align: center; ">
                ...
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
                <th rowspan="4 " style="width: 64px;">S=</th>
                <th rowspan="4 " style="width: 64px;border-right: none; word-wrap:break-word; word-break:break-all;">xxxx</th>
            </tr>
            <tr style="height: 50px; text-align: center; ">
                <td>偏转格数Δn</td>
                <td>1</td>
        ...
        <table cellspacing="0" style="width:655px; border-top: none; ">
            ...
            <tr style="height: 50px; text-align: center;">
                ...
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
                <td style="width: 64px; word-wrap:break-word; word-break:break-all;">xxxx</td>
                <th rowspan="4 " style="width: 64px; ">RX=</th>
                <th rowspan="4 " style="width: 64px; border-right: none; word-wrap:break-word; word-break:break-all;">xxxx</th>
            </tr>
            <tr style="height: 50px; text-align: center;">
                <td>偏转格数Δn</td>
        ...
        <h3>六、 思考题<span style="color: red; ">（每题10分，一共20分）</span></h3>
        ...
        <h3>七、 判断题<span style="color: red; ">（每题6分，一共12分）</span></h3>
